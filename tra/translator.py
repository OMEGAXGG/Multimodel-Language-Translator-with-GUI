...
def get_recent_translations(limit=6):
    return db.get_recent_translations(limit)

def delete_recent_translations():
    db.delete_recent_translations()
...
if __name__ == '__main__':
    ...
    if mode == 'text':
        ...
        for translation in recent_translations:
            ...
            print("---")
    elif mode == 'delete_recent':
        delete_recent_translations()  # Call the function to delete recent translations
        print("")
